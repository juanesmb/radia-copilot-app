...
export const translations: TranslationMap = {
  en: {
    ...
    "sidebar.pricingDescription": "Manage your subscription",

    "pricing.tagline": "Plans",
    "pricing.title": "Choose your plan",
    "pricing.subtitle": "Upgrade anytime with automatic proration and manage cancellations from the portal.",
    "pricing.loading": "Loading plans...",
    "pricing.currentPlan": "Current",
    "pricing.perMonth": "month",
    "pricing.billingPeriod": "Monthly billing",
    "pricing.choosePlan": "Choose plan",
    "pricing.changePlan": "Upgrade",
    "pricing.manage": "Manage",
    "pricing.cancelOrUpdate": "Cancel or update",
    "pricing.pending": "Pending confirmation",
    "pricing.error": "Billing request failed",
  },
  es: {
    ...
    "sidebar.pricing": "Planes",
    "sidebar.pricingDescription": "Gestiona tu suscripción",

    "pricing.tagline": "Planes",
    "pricing.title": "Elige tu plan",
    "pricing.subtitle": "Cambia de plan con prorrateo automático y gestiona cancelaciones desde el portal.",
    "pricing.loading": "Cargando planes...",
    "pricing.currentPlan": "Actual",
    "pricing.perMonth": "mes",
    "pricing.billingPeriod": "Facturación mensual",
    "pricing.choosePlan": "Elegir plan",
    "pricing.changePlan": "Mejorar",
    "pricing.manage": "Administrar",
    "pricing.cancelOrUpdate": "Cancelar o actualizar",
    "pricing.pending": "Pendiente de confirmación",
    "pricing.error": "Falló la solicitud de pago",
  },
};
