...
- En la plantilla, cada órgano/estructura describe los parámetros a mencionar (por ejemplo la forma, tamaño, densidad). Primero informa los parámetros conservados (normales) y luego los parámetros con hallazgos positivos. por ejemplo: Higado de forma y tamaño conservados. De densidad aumentada...
